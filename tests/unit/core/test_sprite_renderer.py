...
def create_test_sprite(z_index: int = 0, color: tuple[int, int, int] = (255, 0, 0)) -> tuple[Sprite, str]:
...
def test_render_z_order() -> None:
    ...
    try:
        ...
        paths.append(path1)
        sprite2, path2 = create_test_sprite(z_index=0, color=(0, 255, 0))    # Green, bottom
        paths.append(path2)
        sprite3, path3 = create_test_sprite(z_index=1, color=(0, 0, 255))    # Blue, middle
        paths.append(path3)
